 ...
 * @author wannabe
 */
public class popRenderVideo extends JPopupMenu{
    private Image image;
    public popRenderVideo() {
    setBorderPainted(false);
    setOpaque(false);
    image=new ImageIcon(getClass().getResource("/san/jmat/view/render/panel/gambar/Video-icon2.png")).getImage();
    }
